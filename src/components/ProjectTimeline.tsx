...
const phases = [
  {
    ...
    title: "Discover",
    duration: "Week 1",
    desc: "Stakeholder workshops, competitor audit, and technical scoping. We leave with a locked spec, a fixed quote, and a milestone timeline.",
    deliverables: ["Project brief", "Tech architecture", "Fixed quote"],
    color: "#4555fd",
  },
  {
    num: "02",
    title: "Design",
    duration: "Week 2",
    desc: "Wireframes evolve into a high-fidelity Figma prototype you can click through. Design system tokens, components, and accessibility checks baked in.",
    deliverables: ["Figma prototype", "Design system", "User flows"],
    color: "#7c3aed",
  },
  {
    num: "03",
    title: "Build",
    duration: "Week 3–5",
    desc: "AI-augmented development in weekly sprints. You get a staging URL from day one and a demo every Friday — no black boxes.",
    deliverables: ["Staging URL", "Weekly demos", "CI/CD pipeline"],
    color: "#db2777",
  },
  {
    num: "04",
    title: "Launch",
    duration: "Week 6",
    desc: "Production deploy, monitoring, and a 30-day bug-fix window. Full repo handover with docs — your code, your infra, your IP.",
    deliverables: ["Production deploy", "Repo handover", "30-day support"],
    color: "#059669",
  },
];
